...
const PermissionApplicationCategoryServiceFactory = new ServiceFactory<PermissionApplicationCategoryInfosDTO, PermissionApplicationCategoryInfos>("permissionApplicationCategory", PermissionApplicationCategoryInfos).create(factory => factory.build(
