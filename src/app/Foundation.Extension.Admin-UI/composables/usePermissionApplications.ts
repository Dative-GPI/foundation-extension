...
const PermissionApplicationServiceFactory = new ServiceFactory<PermissionApplicationInfosDTO, PermissionApplicationInfos>("extensionPermissionApplication", PermissionApplicationInfos).create(factory => factory.build(
