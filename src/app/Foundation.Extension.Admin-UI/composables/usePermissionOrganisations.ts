...
const PermissionOrganisationServiceFactory = new ServiceFactory<PermissionOrganisationInfosDTO,PermissionOrganisationInfos>("extensionPermissionOrganisation", PermissionOrganisationInfos).create(factory => factory.build(
