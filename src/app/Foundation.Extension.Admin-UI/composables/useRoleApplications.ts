...
const RoleApplicationServiceFactory = new ServiceFactory<RoleApplicationDetailsDTO, RoleApplicationDetails>("extensionRoleApplication", RoleApplicationDetails).create(factory => factory.build(
