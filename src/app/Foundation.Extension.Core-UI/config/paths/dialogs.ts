...
export const UPDATE_ROLE_PERMISSION_ORGANISATION_DIALOG_PATH = (roleId: string, dialogId?: string) => `${CORE_PATH()}/dialogs/role-permission-organisations/${encodeURIComponent(roleId)}/update?dialogId=${dialogId}`;