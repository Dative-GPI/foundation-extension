...
namespace Foundation.Extension.Core.Services
{
    public class WidgetTemplateService : IWidgetTemplateService
    {
        ...
        public async Task<IEnumerable<WidgetTemplateInfosFoundationModel>> GetMany(string languageCode, WidgetTemplatesFilterFoundationModel filter)
        {
            ...
            return _mapper.Map<IEnumerable<WidgetTemplateInfos>, IEnumerable<WidgetTemplateInfosFoundationModel>>(result, opt => opt.Items.Add(Consts.LANGUAGE, languageCode));
        }
    }
}